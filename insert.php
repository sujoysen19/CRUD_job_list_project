...
<html lang="en">
  ...
  <body>
  <h1 class="text-center my-4"><u>Entry the record</u></h1>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" name="eligible">
  </div>
  <div class="form-group">
    <label for="detail1">Enter the details</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" name="details"></textarea>
  </div>
  <br>
